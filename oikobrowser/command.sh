...
# synteny tracks
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/Bar2_p4/resources/synteny/OSKA2016v1.9.chain -t SyntenyTrack -a OSKA2016v1.9,Bar2_p4 --trackId="OSAtoBAR_synteny" --category "Synteny" -d "Synteny track of OSKA2016v1.9 mapped to Bar2_p4"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/OKI.I69/resources/synteny/OSKA2016v1.9.chain -t SyntenyTrack -a OSKA2016v1.9,OKI.I69 --trackId="OSAtoOKI_synteny" --category "Synteny" -d "Synteny track of OSKA2016v1.9 mapped to OKI.I69"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/OSKA2016v1.9/resources/synteny/OKI2018_I69_1.0.chain -t SyntenyTrack -a OKI.I69,OSKA2016v1.9 --trackId="OKItoOSA_synteny" --category "Synteny" -d "Synteny track of OKI.I69 mapped to OSKA2016v1.9"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/Bar2_p4/resources/synteny/OKI2018_I69_1.0.chain -t SyntenyTrack -a OKI.I69,Bar2_p4 --trackId="OKItoBAR_synteny" --category "Synteny" -d "Synteny track of OKI.I69 mapped to Bar2_p4"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/OSKA2016v1.9/resources/synteny/Bar2_p4.chain -t SyntenyTrack -a Bar2_p4,OSKA2016v1.9 --trackId="BARtoOSA_synteny" --category "Synteny" -d "Synteny track of Bar2_p4 mapped to OSKA2016v1.9"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/OKI.I69/resources/synteny/Bar2_p4.chain -t SyntenyTrack -a Bar2_p4,OKI.I69 --trackId="BARtoOKI_synteny" --category "Synteny" -d "Synteny track of Bar2_p4 mapped to OKI.I69"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/OSKA2016v1.9/resources/synteny/OdB3.chain -t SyntenyTrack -a OdB3,OSKA2016v1.9 --trackId="NORtoOSA_synteny" --category "Synteny" -d "Synteny track of OdB3 mapped to OSKA2016v1.9"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/Bar2_p4/resources/synteny/OdB3.chain -t SyntenyTrack -a OdB3,Bar2_p4 --trackId="NORtoBAR_synteny" --category "Synteny" -d "Synteny track of OdB3 mapped to Bar2_p4"
jbrowse add-track https://raw.githubusercontent.com/oist/Oikopleuradioica_genomeannotation/main/OKI.I69/resources/synteny/OdB3.chain -t SyntenyTrack -a OdB3,OKI.I69 --trackId="NORtoOKI_synteny" --category "Synteny" -d "Synteny track of OdB3 mapped to OKI.I69"
